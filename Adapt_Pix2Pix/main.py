...
parser.add_argument('--log_dir', dest='log_dir', default='log', help='log are saved here')
parser.add_argument('--save_dir', dest='save_dir', default='save', help='save all')

args = parser.parse_args()

gpu_memory_require = 4.0
